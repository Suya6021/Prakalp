    ...
    >
      <div className=" flex flex-col justify-center gap-4 md:gap-8">
        <div className="flex flex-col gap-2">
          <div className="flex text-xl md:text-2xl gap-2 text-start items-center">
            <IoMdFastforward size={34} />
            Event Details
          </div>
          <div
            className={twJoin("text-4xl md:text-6xl ", boldLexend.className)}
          >
            Things to{" "}
      ...
      <div className="grid grid-cols-2 grid-rows-2 place-content-stretch gap-8 tracking-wider">
        {boxes?.map((ele, ind) => {
          return (
            ...
            >
              <div className="w-full bg-black h-full flex flex-col gap-3 justify-center items-center rounded-sm text-center p-6 md:py-12">
