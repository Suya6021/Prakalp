...
const Prize = () => {
  return (
    <div
      className={twJoin(
        lexend.className,
        "w-full mt-[180px] min-h-full pb-28 md:px-0"
      )}
    >
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="flex gap-4 md:gap-12 mt-[80px] w-full justify-center md:justify-around items-center">
        ...
        <div className="md:text-left text-center md:text-xl tracking-wider mt-20">
