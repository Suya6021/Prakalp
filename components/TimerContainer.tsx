 ...
 if( hours == 0){
   ...
   if(Number(seconds) < 10){
    ...
    return (
        ...
        <div className='flex justify-center items-center mt-[110px] flex-col'>
          <div className='w-full flex justify-center items-center text-xl md:text-2xl'>
          <h2>Time’s <span className={twJoin(lexend.className,"italic text-xl md:text-2xl/4")}>running</span> up for registration!</h2>
          </div>
